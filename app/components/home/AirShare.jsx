...
export default function AirShare() {
  ...
  return (
    ...
    >
      ...
      >
        <Wifi className="text-foreground w-16 h-16 transition-transform duration-300 group-hover:scale-110" />
        <p className='bg-transparent text-foreground text-lg font-medium transition-all duration-300 group-hover:font-semibold'>
          AirShare
        </p>
      </motion.div>

      <div className="pointer-events-none absolute inset-0 h-full bg-[radial-gradient(circle_at_50%_120%,rgba(120,198,119,0.3),rgba(255,255,255,0))]" />
    </div>
  );
} 